...
class VerificationPinHadir extends StatefulWidget {
  const VerificationPinHadir({Key key}) : super(key: key);

  @override
  State<VerificationPinHadir> createState() => _VerificationPinHadirState();
}

class _VerificationPinHadirState extends State<VerificationPinHadir> {
  int user_id = 0;
  int id_kelas = 0;
  String nama_siswa = '';
  String kehadiran = '';
